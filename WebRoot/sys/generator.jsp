				...
				<td>
					<div id="step2Panel">
						<fieldset style="border: 1px solid #ccc;font-size: 12px;">
						    ...
						    <table>
						    	<tr>
						    		<td>api根目录: </td><td id="txt-apiPath"></td>
						    		<td>web根目录: </td><td id="txt-webPath"></td>
						    		<td>server根目录: </td><td id="txt-serverPath"></td>
						    	</tr>
						    	<tr>
						    		<td>service: </td><td id="txt-service"></td>
						    		<td>package: </td><td id="txt-packageName"></td>
						    		<td>文件编码: </td><td id="txt-charset"></td>	
						    	</tr>
						    	<tr>
						    		<td colspan="2">是否覆盖生成目录下重名文件: </td><td id="rad-cover" colspan="4"></td>
						    	</tr>
						    </table>
						</fieldset>
					</div>
