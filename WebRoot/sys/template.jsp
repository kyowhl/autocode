   		...
   		<table class="insert-tab" width="100%">
        	...
        	<tbody>
                <tr>
                    ...
                    <th width="80"><i class="require-red">*</i>说明：</th>
                    <td id="txt-desc" width="100"></td>
                    <td><a href="#" class="link" onclick="VelocityHelper.show(); return false;">查看Velocity参数</a></td>
                </tr>
                <tr>
...
formPanel = new FDFormPanel({
	...
	,controls:[
		...
		,new FDTextBox({domId:'txt-desc',name:'desc',msgId:'formMsg'
			,validates:[
		     {rule:{notNull:true},successClass:'green',errorClass:'require-red',errorMsg:'说明不能为空'}
		     ,{rule:{maxLength:60},successClass:'green',errorClass:'require-red',errorMsg:'说明长度不能大于60'}
		     ]
		})
